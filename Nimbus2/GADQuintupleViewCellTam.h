...
@interface GADQuintupleViewCellTam : UITableViewCell{
    UIButton *oldButton;
    UIButton *oldButton2;
    UIButton *oldButton3;
    UIButton *oldButton4;
...
@property (weak, nonatomic) IBOutlet UILabel *detailsLabel5;
@property (weak, nonatomic) IBOutlet UIButton *AE5;
@property (weak, nonatomic) IBOutlet UIButton *PE5;
@property (weak, nonatomic) IBOutlet UIButton *E5;
@property (weak, nonatomic) IBOutlet UIButton *SE5;
@property (weak, nonatomic) IBOutlet UIButton *EX5;
@property (weak, nonatomic) IBOutlet UIButton *NOT5;
