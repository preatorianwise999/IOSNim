...
#import "DOMEconomyCabCondition.h"
#import "AddRowCell.h"
...
@interface DOMEconomyCabCondition ()<UITextFieldDelegate,PopoverDelegate>
{
...
@implementation DOMEconomyCabCondition
...
- (void)viewDidLoad
{
    ...
    [_stateCabConditionTableView setBackgroundColor:[UIColor clearColor]];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if(section == 0) {
        sectionTitle = [appDel copyTextForKey:@"CONDITIONING_CAB"];
    }
...
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if([textField.accessibilityIdentifier isEqualToString:[appDel copyEnglishTextForKey:@"AMOUNT"]]) {
        ...
        else if(![string validateNumeric]) {
