//
//  TNBEconomyQualityServiceViewController.m
//  LATAM
//
...
#import "TNBEconomyQualityServiceViewController.h"
#import "AddRowCell.h"
...
@interface TNBEconomyQualityServiceViewController ()<UITextFieldDelegate,PopoverDelegate> {
...
@implementation TNBEconomyQualityServiceViewController
...
- (void)viewDidLoad
{
    ...
    DLog(@" viewDidLoad == %@",[LTSingleton getSharedSingletonInstance].flightRoasterDict);
...
-(void)setContentInFormDictForView:(id)view
{
    ...
    if(ISiOS8)
        ...
        indexPath = ((OffsetCustomCell *)[[[view superview] superview] superview]).indexPath;    if(indexPath == nil)
        return;
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return  qualityCateringServiceArr.count + 1;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else if(comboComboComboNumTextCameraCell)
    {
        ...
        comboComboComboNumTextCameraCell.optionTxt.typeOfDropDown = NormalDropDown;
        ...
        comboComboComboNumTextCameraCell.reportTxt.dataSource = [self getDropDownDataForGroup:@"QUALITY_CATERING_SERVICE" event:@"QUALITY_OF_SERVICE" content:@"REPORT"];
        ...
        comboComboComboNumTextCameraCell.reportLbl.attributedText = [[[appDel copyTextForKey:@"REPORT"] stringByAppendingString:@"*"] mandatoryString];
...
//        //            comboComboComboNumTextCameraCell.cameraView.imageData=[self getImageContentInFormDictForView:comboComboComboNumTextCameraCell.cameraView];
//        //            NSString *myString = [[NSString alloc] initWithData: comboComboComboNumTextCameraCell.cameraView.imageData encoding:NSUTF8StringEncoding];
