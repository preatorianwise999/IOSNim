...
#import "DOMOverviewViewController.h"
...
@interface DOMOverviewViewController ()
{
...
@implementation DOMOverviewViewController
...
-(void)initializeData{
    ...
    if ([groupArr count] == 0) {
        ...
        //        [groupDict setObject:singleVueloDict forKey:@"singleEvents"];
...
- (void)viewDidLoad
{
    ...
    TextTextCell *celltest;
    UIColor *color = [UIColor redColor];

    celltest.productTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"" attributes:@{NSForegroundColorAttributeName: color}];
    ...
    CGRect newframe = _headingLabel.frame;
    newframe.origin.y=kyposition_NB_LAN_General;//pass the cordinate which you want
    newframe.origin.x=kxposition_NB_LAN_General;
    _headingLabel.frame= newframe;
    _header_Line.frame = CGRectMake(15, 37,555,8);
...
-(NSString *)getContentInFormDictForView:(id)view
{
    ...
    if(indexPath.section == 0) {
        ...
        if(indexPath.row == 0){
            ...
            //                rowName = [appDel copyEnglishTextForKey:@"GENERAL_WCH_OBSERVATIONS"];
            //            }
        }
            ...
            //            if([view isKindOfClass:[TestView class]]){
            //                rowName = [appDel copyEnglishTextForKey:@"GENERAL_ARNES_OBSERVATIONS"];
            //            }
        }
...
-(void)valueSelectedInPopover:(TestView *)testView{
    ...
    // NSIndexPath *indexPath = ((OffsetCustomCell *)[[[testView superview] superview] superview]).indexPath;
    ...
    //        [_overviewTableView reloadRowsAtIndexPaths:[NSArray arrayWithObject:indexPath] withRowAnimation:UITableViewRowAnimationNone];
    //        [_overviewTableView endUpdates];
    //        [_overviewTableView reloadData];
    //to avoid crash
...
-(void)textFieldDidEndEditing:(UITextField *)textField
{
    ...
    if([LTSingleton getSharedSingletonInstance].legPressed == YES){
        NSIndexPath *indexPath = ((OffsetCustomCell *)(refrence)).indexPath;
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //    if(indexPath.section == 1 && indexPath.row > 3+[flightOccurencesArray count] ){
    //        return 64;
    //    }
...
-(void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(editingStyle == UITableViewCellEditingStyleInsert){
        if(indexPath.section == 0){
            sectionName = [appDel copyEnglishTextForKey:@"GENERAL_EMBARQUE"];
            rowName = [appDel copyEnglishTextForKey:@"GENERAL_EMBARQUE_OCC"];
            //            modifiedIndexpath = [NSIndexPath indexPathForItem:[embarqueOccurencesArray count]+2 inSection:0];
            ...
            if(indexPath.row == 2){
                rowName = [appDel copyEnglishTextForKey:@"GENERAL_VUELO_OCC"];
                //                modifiedIndexpath = [NSIndexPath indexPathForItem:[flightOccurencesArray count]+3 inSection:1];
                [flightOccurencesArray addObject:[NSNumber numberWithInt:[flightOccurencesArray count]+1]];
                
            }
            else{
                rowName = [appDel copyEnglishTextForKey:@"GENERAL_CUMPLE_OCC"];
                //                modifiedIndexpath = [NSIndexPath indexPathForItem:[flightOccurencesArray count]+[superiorFlightOccurencesArray count]+4 inSection:1];
            ...
            sectionName = [appDel copyEnglishTextForKey:@"GENERAL_DESEMBARQUE"];
            rowName = [appDel copyEnglishTextForKey:@"GENERAL_DESEMBARQUE_OCC"];
            //            modifiedIndexpath = [NSIndexPath indexPathForItem:[desembarqueOccurencesArray count]+2 inSection:2];
            ...
            sectionName = [appDel copyEnglishTextForKey:@"GENERAL_DOCUMENTOS"];
            rowName = [appDel copyEnglishTextForKey:@"GENERAL_DOCUMENTOS_OCC"];
            //            modifiedIndexpath = [NSIndexPath indexPathForItem:[documentsAddedArray count]+1 inSection:3];
...
//    static NSString *twoButtonIdentifier =  @"TwoButtonCell";
    ...
    if(indexPath.section == 0) {
        if(indexPath.row == 0) {
            ...
            ((ComboBoxTextCell *)cell).alertComboView.notesView.font = kFontName_Robotica_Light;
        ...
        if(indexPath.row == 0 || indexPath.row == 1){
            ...
            cell.leftLabel.text = ((indexPath.row)?[appDel copyEnglishTextForKey:@"GENERAL_SOLICITUD_ARNES"]:[appDel copyTextForKey:@"GENERAL_SOLICITUD_WCH"]);
            //[[((indexPath.row)?[appDel copyEnglishTextForKey:@"GENERAL_SOLICITUD_ARNES"]:[appDel copyTextForKey:@"GENERAL_SOLICITUD_WCH"]) stringByAppendingString:@"*"] mandatoryString];
            cell.indexPath = indexPath;
            ...
            //            ((NumberTextCell *)cell).alertComboView.key = (indexPath.row)?[appDel copyEnglishTextForKey:@"GENERAL_ARNES_OBSERVATIONS"]:[appDel copyEnglishTextForKey:@"GENERAL_WCH_OBSERVATIONS"];
            ...
            //  ((TextTextCell *)cell).productTextField.inputAccessoryView=[self keyboardToolBar];
            //   ((TextTextCell *)cell).quantityTextField.inputAccessoryView=[self keyboardToolBar];
        ...
        if(indexPath.row == 0){
            ...
            // ((ComboTextTextCell *)cell).observationLabel.attributedText = [[[appDel copyTextForKey:@"OBSERVATION"] stringByAppendingString:@"*"] mandatoryString];
            ...
            //((ComboTextTextCell *)cell).textField.inputAccessoryView = [self keyboardToolBar];
