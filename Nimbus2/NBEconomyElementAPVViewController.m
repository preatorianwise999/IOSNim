...
@interface NBEconomyElementAPVViewController ()
{
...
@implementation NBEconomyElementAPVViewController
...
- (void)viewDidLoad
{
    ...
    [_apvElementsTableView setBackgroundColor:[UIColor clearColor]];
