//
//  TDOMEconomyCabinViewController_TAM.m
//  LATAM
//
...
#import "TDOMEconomyCabinViewController_TAM.h"
#import "AddRowCell.h"
...
//#import "DatabaseOperations.h"  //Commented Pavan
#import "CabinLabelComboObservationCell.h"
#import "LTGetDropDownvalue.h"

@interface TDOMEconomyCabinViewController_TAM ()<UITextFieldDelegate,PopoverDelegate,ComboNumTextTextDelegate>
{
...
@implementation TDOMEconomyCabinViewController_TAM
...
- (void)viewDidLoad
{
    ...
    _cabinTableView.separatorStyle  = UITableViewCellSeparatorStyleNone;
...
-(void)initializeData
{
    ...
    if ([groupArr count] == 0 ) {
        ...
        //[groupDict setObject:[NSMutableDictionary dictionaryWithObjectsAndKeys:@"",[appDel copyEnglishTextForKey:@"TEMPERATURE"], nil] forKey:@"singleEvents"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section == 0)
    {
        ...
        else if(indexPath.row < bathroomsArr.count + 1)
        {
            ...
            otherTextCameraCell.reasonTxt.dataSource = [self getDropDownDataForGroup:@"IMPECCABILITY_OF_CAB" event:@"TOILETS" content:@"OCCURRENCE_TAM"];
            otherTextCameraCell.reasonTxt.typeOfDropDown = OtherDropDown;
            otherTextCameraCell.reasonTxt.key = [appDel copyEnglishTextForKey:@"OCCURRENCE_TAM"];
        ...
        else if(indexPath.row < bathroomsArr.count + galleyArr.count + 2)
        {
            ...
            otherTextCameraCell.reasonTxt.delegate = self;
            otherTextCameraCell.reasonTxt.dataSource = [self getDropDownDataForGroup:@"IMPECCABILITY_OF_CAB" event:@"GALLEY" content:@"OCCURRENCE_TAM"];
            otherTextCameraCell.reasonTxt.typeOfDropDown = OtherDropDown;
            otherTextCameraCell.reasonTxt.key = [appDel copyEnglishTextForKey:@"OCCURRENCE_TAM"];
        ...
        else if(indexPath.row < bathroomsArr.count + galleyArr.count + cabinArr.count + 3)
        {
            ...
            otherTextCameraCell.reasonTxt.delegate = self;
            otherTextCameraCell.reasonTxt.dataSource = [self getDropDownDataForGroup:@"IMPECCABILITY_OF_CAB" event:@"CABIN" content:@"OCCURRENCE_TAM"];
            otherTextCameraCell.reasonTxt.typeOfDropDown = OtherDropDown;
            otherTextCameraCell.reasonTxt.key = [appDel copyEnglishTextForKey:@"OCCURRENCE_TAM"];
    ...
    else if(comboTextCell)
    {
        ...
        comboTextCell.reportTxt.dataSource = [NSArray arrayWithObjects:@"A340",@"B767",@"B787", nil];
        comboTextCell.reportTxt.typeOfDropDown = NormalDropDown;
        comboTextCell.reportTxt.key = [appDel copyEnglishTextForKey:@"OCCURRENCE_TAM"];
        
        comboTextCell.reportLbl.attributedText = [[[appDel copyTextForKey:@"OCCURRENCE_TAM"] stringByAppendingString:@"*"] mandatoryString];
    ...
    else if(labelComboObservationCell)
    {
        ...
        labelComboObservationCell.reasonCombobox.dataSource = [self getDropDownDataForGroup:@"IMPECCABILITY_OF_CAB" event:@"TEMPERATURE" content:@"OCCURRENCE_TAM"];
        labelComboObservationCell.reasonCombobox.typeOfDropDown = NormalDropDown;
        labelComboObservationCell.reasonCombobox.key = [appDel copyEnglishTextForKey:@"OCCURRENCE_TAM"];
