...
#import "TWBEconomyAirportViewController.h"
...
@interface TWBEconomyAirportViewController ()
{
...
@implementation TWBEconomyAirportViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section == 0)
    {
        ...
        else
        {
            ...
            otherNumTextCameraCell.amountLbl.text = [appDel copyTextForKey:@"AMOUNT"];
    ...
    else
    {
        ...
        else
        {
            ...
            otherTextCell.reportLbl.text = [appDel copyTextForKey:@"REPORT_TAM"];
            otherTextCell.passengerNameLbl.text = [appDel copyTextForKey:@"AIRPORT_FULLNAME"];
...
//    headerLabel.frame = CGRectMake(0, 18, tableView.frame.size.width, 20);
//    headerLabel.backgroundColor = [UIColor clearColor];
//    headerLabel.textColor = [UIColor colorWithRed:128.0f/256.0 green:128.0f/256 blue:128.0f/256 alpha:1];
...
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    ...
    if([string length] == 0 && range.location == 0 && [LTSingleton getSharedSingletonInstance].sendReport){
