//
//  TAMWBSuggestionsViewController.m
//  LATAM
//
...
#import "TAMWBSuggestionsViewController.h"
...
@interface TAMWBSuggestionsViewController ()
{
...
@implementation TAMWBSuggestionsViewController
...
-(void)initializeData {
    ...
    if ([groupArr count] == 0) {
        ...
        NSMutableDictionary *vueloDict = [NSMutableDictionary dictionaryWithObjects:[NSArray arrayWithObjects:[[NSMutableString alloc] init],[[NSMutableString alloc] init],[[NSMutableString alloc] init],[[NSMutableString alloc] init] , nil] forKeys:[NSArray arrayWithObjects:[appDel copyEnglishTextForKey:@"GENERAL_VUELO_SUGEGSTIONS"],[appDel copyEnglishTextForKey:@"GENERAL_FIRST_SUGEGSTIONS"],[appDel copyEnglishTextForKey:@"GENERAL_BUSINESS_SUGEGSTIONS"],[appDel copyEnglishTextForKey:@"GENERAL_ECONOMY_SUGEGSTIONS"], nil]];
...
- (void)viewDidLoad
{
    ...
    sectionArray = [[NSMutableArray alloc] initWithObjects:[appDel copyTextForKey:@"GENERAL_VUELO_SUGEGSTIONS"],[appDel copyTextForKey:@"GENERAL_FIRST_SUGEGSTIONS"],[appDel copyTextForKey:@"GENERAL_BUSINESS_SUGEGSTIONS"],[appDel copyTextForKey:@"GENERAL_ECONOMY_SUGEGSTIONS"], nil];
    self.headingLabel.text = [appDel copyTextForKey:@"Suggestions"];
...
-(NSString *)getContentInFormDictForView:(id)view
{
    ...
    if(indexPath.section == 0){
        ...
        rowName =[appDel copyEnglishTextForKey:@"GENERAL_FIRST_SUGEGSTIONS"];
    }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //((OnlyTextViewCell *)cell).textView.textColor = kFontColor;
