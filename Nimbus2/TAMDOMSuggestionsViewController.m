//
//  TAMDOMSuggestionsViewController.m
//  LATAM
//
...
#import "TAMDOMSuggestionsViewController.h"
...
@interface TAMDOMSuggestionsViewController ()
{
...
@implementation TAMDOMSuggestionsViewController
...
- (void)viewDidLoad
{
    ...
    sectionArray = [[NSMutableArray alloc] initWithObjects:@"Sugestões e comentários gerais do Voo",@"Sugestões e comentários gerais do Voo - Cabine Ecomomy", nil];
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text {
    ...
    if([text length] == 0 && range.location == 0 && [LTSingleton getSharedSingletonInstance].sendReport){
        textView.layer.borderColor = [[UIColor redColor] CGColor];
    }
