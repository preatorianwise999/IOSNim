//
//  NBEconomyElementAPVViewController.m
//  LATAM
//
...
#import "WBEconomyElementsAndCateringSuppliesViewController.h"
...
@interface WBEconomyElementsAndCateringSuppliesViewController ()
{
...
@implementation WBEconomyElementsAndCateringSuppliesViewController
...
- (void)initializeData
{
    ...
    NSString *report = [[[[[flightRoaster objectForKey:@"legs"] objectAtIndex:0]objectForKey:@"reports"] objectAtIndex:0] objectForKey:@"name"];
    NSString *section = [[[[[[[flightRoaster objectForKey:@"legs"] objectAtIndex:0]objectForKey:@"reports"] objectAtIndex:0] objectForKey:@"sections"] objectAtIndex:0] objectForKey:@"name"];
